...
const styles = {
  ...
  // We don't just pass an array of loaders, we run them through the extract plugin so they can be 
  // outputted to their own .css file
...
const config = {
  ...
  // remember we said webpack sees everthing as modules and how different loaders are responsible 
  // for different file types? Here is is where we implement them. Pass it the rules for our JS and our styles
  module: {
