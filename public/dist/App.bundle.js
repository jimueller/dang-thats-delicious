...
function ajaxHeart(e) {
  ...
  _axios2.default.post(this.action).then(function (res) {
    ...
    if (isHearted) {
      ...
      _this.heart.closest('.store').outerHTML = '';
    }
  }).catch(function (err) {
...
function loadPlaces(map) {
  ...
  // TODO ask for location geoloction JS 30 Day 21
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/stores/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
  ...
  searchInput.on('keyup', function (e) {
    ...
    var items = document.querySelectorAll('.search__result');
    var next = void 0;
